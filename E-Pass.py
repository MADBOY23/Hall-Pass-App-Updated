...
def submit_pass(name, destination):
    ...
    #Deletes the inputs in the entry box
    name_bath.delete(0, tk.END)
    name_office.delete(0, tk.END)
    name_nurse.delete(0, tk.END)
    name_classroom.delete(0, tk.END)
    num_classroom.delete(0, tk.END)
